    ...
    <>
      <div className="w-full flex justify-between items-center font-mono">
        ...
        <div className="flex items-center gap-4">
            <p className="bg-blue-900 text-white text-[15px] px-4 py-1 rounded-2xl hidden md:block cursor-pointer">Explore premium</p>
            <p className="bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer">Install App</p>
            <p className="bg-purple-500 text-white w-7 h-7 rounded-full flex items-center justify-center">D</p>
        </div>
      </div>
